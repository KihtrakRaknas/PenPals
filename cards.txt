var cardInfo = {
  ...
  "Card of Memories" :{
    price: 3.00,
    description: "This beautiful card can be personalized for all occaisions. It portrays a mosaic of your best memories with the reciever, and of course, privacy is always of importance, and none of the details will ever be released without your legal and written consent. Some popular occaisions for this card are Weddings, Sweet 16s, New Year's and other milestone occasions.\nAdditionally, beyond the events, the colors and fonts can always be personalized.",
    customText: true,
    customColor: true ,
    image: ""
  },
  ...
  "Holiday Candle Card" :{
    price: 3.00,
    description: "This beautiful candle card truly embraced the warmth and joy of the holiday time! Give this card to spread the light and happiness of the season! As always, writing, colors, and embellishments are easily customizable at no additional cost.",
    customText: true,
    customColor: true,
    image:""
  },
  "Vibrant Ornament Card" :{
    price: 3.00,
  ...
  "Light it Up Hanukkah Card" :{
    price: 3.00,
    description: "This beautiful card reminds the receiver the meaning of this beautiful holiday, a festival of light in a cold time. Give your loved ones a captivating gift, celebrating an amazing holiday! \nAs always, fonts, colors, and any other writing you want personalized are entirely up to you, though in our expert opinion, this color really seems to suit the season.",
    customText: true,
    customColor: true,
    image: ""
  },
  ...
  "Winter Building Card":{
    price: 3.00,
    description: "This card was actually a completely custom made card by a customer, but we loved the idea so much that we made it an actual card we sell! Order your winter building cards, whether it be a school (like this one) or another meaningful building. \nExclusive for the holidays",
    customText: true,
    customText: true,
    image: ""
  }
